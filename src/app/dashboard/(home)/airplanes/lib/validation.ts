...
const MAX_FILE_SIZE = 2000000 // 2 MG
...
export const airplaneFormSchema = z.object({
     ...
     image: z.any().refine((file:File)=> ACCEPTED_IMAGE_TYPES.includes(file.type),"Image harus berekstensi jpg,jpeg, dan png").refine((file:File)=>file.size <= MAX_FILE_SIZE,"Image harus memiliki ukuran minimal 2MB")
 })